export function Newbrands(props: any) {
  return (
    <div className="px-7 md:px-10 pt-24 mx-auto">
      <div className="flex flex-col items-center justify-center text-center w-full md:mb-20 2xl:mb-[8vh]">
        <h1 className="w-fit font-museoModernoLight text-awkbit-fuchsia text-pink-500 text-featureTitleGridMobile smallMobileScreen:text-featureTitleGrid md:text-8xl font-normal uppercase md:leading-[0.5] text-end 2xl:text-[17vh] 2xl:leading-[8vh] drop-shadow-[0_0_0.2em_#f44f59]">
          {props.t1}
          <span className="text-xl smallMobileScreen:text-2xl md:text-5xl font-museoModernoRegular text-pink-300 uppercase 2xl:text-[3vw]">
            {props.t2}
          </span>
        </h1>
      </div>
