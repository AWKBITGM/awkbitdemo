export function Newrightserviceblock(props: any) {
  return (
    <div className="container mx-auto">
      <div className="flex px-7 md:p-10 mb-8 lg:mb-0 md:flex-row flex-col items-center justify-center gap-y-8 md:gap-x-16 lg:gap-x-36 2xl:mb-[6vw] 2xl:gap-x-[8vw]">
        ...
        <div className="w-full md:w-1/2 flex">
          <div className="flex flex-col items-start text-left">
            <h1 className="uppercase font-museoModernoRegular text-featureTitleMobile smallScreen:text-featureTitle text-purple-100 2xl:text-[3vw] 2xl:leading-[2.5vw]">
              get<span className="text-pink-300">{props.t2}</span>
              <br />
              whatever it takes
            </h1>
            ...
            <p className="font-ubuntuRegular leading-6 text-awkbit-lightPurplae text-lg smallScreen:text-2xl 2xl:text-[1.5vw] 2xl:leading-[1.5vw]">
              {props.t4}
            </p>
        ...
        <div className="md:w-1/2 justify-end items-center hidden md:flex">
          {props.t6}
        </div>
      </div>
    </div>
