export function Hero3(props: any) {
  return (
          ...
          <div className="absolute top-0 bottom-0 w-full">
            ...
            <div className="w-full flex">
              <div className="w-1/2 flex flex-col items-end">
                ...
                <h1 className="text-end text-titleHeroMobile sm:text-titleHero font-light font-medium text-white font-museoModernoLight mb-[30px] lg:mb-[2.5vw]">
                  we
