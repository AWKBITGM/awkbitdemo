export function Hero2(props: any) {
  return (
          ...
          <div className="absolute top-0 bottom-0 w-full">
            ...
            <div className="w-full flex">
              <div className="w-1/2 flex flex-col items-end">
                ...
                <h1 className="text-end text-titleHeroMobile sm:text-titleHero font-light font-medium text-white font-museoModernoLight mb-[20px] lg:mb-[2.5vw]">
                  we
                ...
                <p className="mr-2.5 text-base sm:text-subtitleHero text-awkbit-fuchsia font-normal uppercase font-museoModernoLight mb-[4vw]">
                  {props.t7}
                </p>
